...
// Panggil fungsi untuk tabel bfc
list($review_count_bfc, $avg_rating_bfc) = getWarungRating($conn, $warung_id, 'bfc');
...
// Panggil fungsi untuk tabel warbang
list($review_count_warbang, $avg_rating_warbang) = getWarungRating($conn, $warung_id, 'warbang');
// Panggil fungsi untuk tabel crispy54
list($review_count_crispy54, $avg_rating_crispy54) = getWarungRating($conn, $warung_id, 'crispy54');
...
// Panggil fungsi untuk tabel mariyam
list($review_count_mariyam, $avg_rating_mariyam) = getWarungRating($conn, $warung_id, 'mariyam');
// Panggil fungsi untuk tabel ayambaek
list($review_count_ayambaek, $avg_rating_ayambaek) = getWarungRating($conn, $warung_id, 'ayambaek');
        ...
        <ul class="navigation">
            ...
            <form id="searchForm" class="search">
                ...
                <datalist id="warungList">
                    <option value="Bismillah Fried Chicken">
    ...
    <div class="main">
        ...
        <div class="macam-warung1">
            <div class="warung1 warung-item">
                <img src="Gambar/bfc.jpg" class="gambar-BFC" onclick="openModal(this)">
                <h1 class="title-BFC">Bismillah Fried Chicken</h1>
                <div class="penilaian-BFC">
                    <img src="Gambar/Star 1.png">
                    <h4><?php echo $avg_rating_bfc; ?> / <?php echo $review_count_bfc; ?> ulasan</h4>
                </div>
                <div class="tombol1">
            ...
            <div class="warung3 warung-item">
                ...
                <div class="penilaian-warbang">
                    <img src="Gambar/Star 1.png">
                    <h4><?php echo $avg_rating_warbang; ?> / <?php echo $review_count_warbang; ?> ulasan</h4>
                </div>
                <div class="tombol3">
                    <a href="warbang.php" style="text-decoration: none;">
                        <div class="menu3">
                            <b>MENU</b>
                        </div>
                    </a>
            ...
            <div class="warung4 warung-item">
                ...
                <div class="penilaian-crispy54">
                    <img src="Gambar/Star 1.png">
                    <h4><?php echo $avg_rating_crispy54; ?> / <?php echo $review_count_crispy54; ?> ulasan</h4>
                </div>
                <div class="tombol4">
                    <a href="crispy54.php" style="text-decoration: none;">
                        <div class="menu4">
                            <b>MENU</b>
                        </div>
                    </a>
        ...
        <div class="macam-warung2">
            ...
            <div class="warung7 warung-item">
                ...
                <div class="penilaian-kedaimariyam">
                    <img src="Gambar/Star 1.png">
                    <h4><?php echo $avg_rating_mariyam; ?> / <?php echo $review_count_mariyam; ?> ulasan</h4>
                </div>
                <div class="tombol7">
                    <a href="mariyam.php" style="text-decoration: none;">
                        <div class="menu7">
                            <b>MENU</b>
                        </div>
                    </a>
            ...
            <div class="warung8 warung-item">
                ...
                <div class="penilaian-ayambaek">
                    <img src="Gambar/Star 1.png">
                    <h4><?php echo $avg_rating_ayambaek; ?> / <?php echo $review_count_ayambaek; ?> ulasan</h4>
                </div>
                <div class="tombol8">
                    <a href="ayambaek.php" style="text-decoration: none;">
                        <div class="menu8">
                            <b>MENU</b>
                        </div>
                    </a>
